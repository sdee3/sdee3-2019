		...
		if (email.length) {
			...
			if (re.test(email)) {
				if (message.length) {
					...
					return 'The message field is missing! Please try again.';
				}
			} else {
				return 'The email address value is invalid! Please try again.';
			}
		} else {
			return 'The email field is missing! Please try again.';
		}
	} else {
		return 'The name field is missing! Please try again.';
	}
};
